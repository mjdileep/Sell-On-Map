...
export interface LandListPreviewProps {
  ads: Ad[];
  onSelect: (ad: Ad) => void;
        ...
        <div className="p-4">
          ...
          <div className="flex items-center justify-between mt-2">
            <span className="flex items-center space-x-1 text-emerald-700 font-bold">
              ...
              <span>
                {formatCurrency(ad.price, currency)}{ppp ? ` (${formatCurrency(ppp, currency)}/perch)` : ''}
              </span>
            </span>
...
export default function LandListPreview({ ads, onSelect, variant = 'global' }: LandListPreviewProps) {
