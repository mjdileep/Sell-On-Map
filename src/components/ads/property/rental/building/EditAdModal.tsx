...
export default function RentalBuildingEditAdModal({ open, onClose, adId, onSaved }: { open: boolean; onClose: () => void; adId: string; onSaved?: () => void }) {
  ...
  return (
    <Modal open={open} onClose={onClose} title="Edit Building Rental Ad">
